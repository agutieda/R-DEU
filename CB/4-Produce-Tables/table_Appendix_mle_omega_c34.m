...
%   RDEU model using CB data for two different levels of background consumption
...
rdeu_Tab = readtable('./input/rdeu_pooled_mle_baseline.csv', 'ReadRowNames',true);
...
% Export to CSV
writetable(exportTab_CSV, './output/table_appendix_omega_c34.csv', ...
