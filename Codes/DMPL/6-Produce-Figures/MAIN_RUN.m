...
%
% This script:
% - Generate scatterplots of estimates of mu_r and mu_delta by subject shown in Figure 1
% - Generate scatterplots of estimates of sigma_r and sigma_delta by subject shown in Figure 3
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% 1) Fig 1: Scatter of sigma_r and sigma_delta
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

figure_3_scatter_sigma;
