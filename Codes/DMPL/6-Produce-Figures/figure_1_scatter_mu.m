% This script:
% - Generate scatterplots of estimates of mu_r and mu_delta by subject
...
% Extract variables
rdeu_ra = rdeuTab.mu_ra;
rdeu_dr = rdeuTab.mu_dr;
rumL_ra = rumLTab.mu_ra;
rumL_dr = rumLTab.mu_dr;
rumW_ra = rumWTab.mu_ra;
rumW_dr = rumWTab.mu_dr;
sp_ra   = spRTab.avg_ra;
sp_dr   = spTTab.avg_dr;
...
print(fig,'./output/dmpl_scatter_rdeu_mu_ra','-depsc2');
...
set(regLine, 'Parent', ax, 'LineWidth',1.0,'LineStyle','--','Color',line_color);
set(ax,'XGrid','on','YGrid','on');
print(fig,'./output/dmpl_scatter_rdeu_mu_dr','-depsc2');
...
set(regLine, 'Parent', ax, 'LineWidth',1.0,'LineStyle','--','Color',line_color);
set(ax,'XGrid','on','YGrid','on');
print(fig,'./output/dmpl_scatter_rum_luce_mu_ra','-depsc2');
...
set(regLine, 'Parent', ax, 'LineWidth',1.0,'LineStyle','--','Color',line_color);
set(ax,'XGrid','on','YGrid','on');
print(fig,'./output/dmpl_scatter_rum_luce_mu_dr','-depsc2');
...
set(regLine, 'Parent', ax, 'LineWidth',1.0,'LineStyle','--','Color',line_color);
set(ax,'XGrid','on','YGrid','on');
print(fig,'./output/dmpl_scatter_rum_wilcox_mu_ra','-depsc2');
...
set(regLine, 'Parent', ax, 'LineWidth',1.0,'LineStyle','--','Color',line_color);
set(ax,'XGrid','on','YGrid','on');
print(fig,'./output/dmpl_scatter_rum_wilcox_mu_dr','-depsc2');
