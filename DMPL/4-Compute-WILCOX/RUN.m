...
% - Assume RUM model with Wilcox specification following AHLR 2014
...
writetable(rTab,'./output/wilcox_pooled_mle.csv','WriteRowNames',true);
...
writetable(sTab,'./output/wilcox_subject_mle.csv');
